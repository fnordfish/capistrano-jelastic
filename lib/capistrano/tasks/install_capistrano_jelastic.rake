...
# This should be just a copy of
# https://github.com/capistrano/capistrano/blob/master/lib/capistrano/tasks/install.rake
#
# Unfortunately, we cannot simply "load 'capistrano/tasks/install.rake'",
# because the path to the template files are hard coded and bound to the capistrano gem.
